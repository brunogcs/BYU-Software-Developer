...
def parse_formula(formula, periodic_table_dict):
    """Parse a chemical formula and return a compound list that
    stores the quantity of atoms of each element in the molecule.
    ...
    Return
        compound_list (list): a compound list that contains chemical
            symbols and quantities like this [["Fe", 2], ["O", 3]]
    """
